...
```jsx
<Link to="https://jenga-uikit-storybook.netlify.app/">Open Jenga UI Kit</Link> |
(
  <Link to="!https://jenga-uikit-storybook.netlify.app/">
    Open Jenga UI Kit in new tab
  </Link>
);
```
...
<Canvas>
  <Story name="External link">
    <Paragraph>
      ...
      &nbsp; | <Link to="!https://jenga-uikit-storybook.netlify.app/">Open Jenga UI Kit in new tab</Link>
    </Paragraph>
  </Story>
</Canvas>
