...
import type { JengaSliderBaseProps } from './types';

export interface JengaSliderProps extends JengaSliderBaseProps<number> {
  gradation?: string[];
}

function Slider(props: JengaSliderProps, ref: FocusableRef<HTMLDivElement>) {
  const {
    onChange,
    onChangeEnd,
    value,
